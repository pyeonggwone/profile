...
> 네트워크 연동 기준: [hipaa-network.ver3.md](../Implement_Network/hipaa-network.ver3.md) — S2S VPN + Private Endpoint  
...
> 상세 설정은 [hipaa-network.ver3.md §1-3](../Implement_Network/hipaa-network.ver3.md) 참조
...
| 증상 | 확인 사항 | 조치 |
|---|---|---|
| VPN Connection 상태 `Not connected` | 병원 VPN 장비 IKEv2 설정, PSK 일치 여부 | [hipaa-network.ver3.md §1-3](../Implement_Network/hipaa-network.ver3.md) IPsec Policy 재확인 |
