...
|---|---|---|---|---|---|---|---|
| 프로젝트 성격 | 설계/기반 | v1 연동 자동화 | 자립형 통합 | rebuild 개선 | 품질 우선 다중엔진 | object manifest 단순화 | textless 구조 재생성 |
...
| PDF 직접 구조 분석 | O | O | O | O | O | △ | △ |
| stream/filter decode | O | O | O | O | △ | X | X |
