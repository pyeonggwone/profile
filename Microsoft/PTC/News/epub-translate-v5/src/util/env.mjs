...
const LANG_NAME = { en: 'English', ko: 'Korean', kr: 'Korean', ja: 'Japanese', jp: 'Japanese', zh: 'Chinese', ch: 'Chinese' };
const LANG_SUFFIX = { en: 'EN', ko: 'KR', kr: 'KR', ja: 'JP', jp: 'JP', zh: 'CH', ch: 'CH' };
const LANG_TAG = { en: 'en', ko: 'ko', kr: 'ko', ja: 'ja', jp: 'ja', zh: 'zh', ch: 'zh' };
...
export function loadConfig(options = {}) {
    ...
    const cfg = {
        ...
        metadataDir: path.resolve(process.env.METADATA_DIR || 'ebook-metadata'),
        ...
        onlyFormat: options.format ? String(options.format).toLowerCase() : '',
        useAzure,
